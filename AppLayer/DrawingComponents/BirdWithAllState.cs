...
namespace AppLayer.DrawingComponents
{
    ...
    /// class represent a "whole" bird that combines both intrinsic state part and the extrinsic state part.
    ...
    /// </summary>
    [DataContract]
    public class BirdWithAllState : Bird
    {
        public Pen OutlinePen { get; set; } = new Pen(Color.DarkGray);
        internal BirdWithIntrinsicState IntrinsicState { get; }

        [DataMember]
        public BirdExtrinsicState ExtrinsicState { get; set; }

        internal BirdWithAllState(BirdWithIntrinsicState sharedPart, BirdExtrinsicState nonsharedPart)
        {
        ...
        {
            return new BirdWithAllState(IntrinsicState, ExtrinsicState.Clone());
        }

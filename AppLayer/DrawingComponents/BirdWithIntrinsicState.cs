...
namespace AppLayer.DrawingComponents
{
    ...
    /// </summary>
    internal class BirdWithIntrinsicState : Bird
    {
        ...
        public void LoadFromResource(string birdType, Type referenceTypeForAssembly)
        {
            if (string.IsNullOrWhiteSpace(birdType)) return;
            ...
            using (var stream = assembly.GetManifestResourceStream(birdType))
            {
        ...
        public override bool IsSelected
        {
            ...
            set
            {
                throw new ApplicationException("Cannot select a bird with only intrinsic state - the intrinsic state is immutable");
            }
        }
        ...
        public override Point Location
        {
            ...
            set
            {
                throw new ApplicationException("Cannot change a bird with only intrinsic state - the intrinsic state is immutable");
            }
        }
        ...
        {
            throw new ApplicationException("Cannot draw a bird with only intrinsic state");
        }
    }
}
